...
class TestHomeTelefonia {
  ...
  def init() {
    ...
    walterWhite.facturas.add(new Factura(new java.util.Date(10, 1, 109), 500, 240))
    walterWhite.facturas.add(new Factura(new java.util.Date(10, 1, 111), 1200, 600))
    
    jessePinkman = new Rural(100)
    jessePinkman.nombre = "Jesse Pinkman"
    jessePinkman.numero = "45673887"
    jessePinkman.facturas.add(new Factura(new java.util.Date(5, 5, 113), 1200, 1200))
